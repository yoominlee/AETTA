...
class OutDistDataset(torch.utils.data.Dataset):  # OOD dataset with base CIFAR10
    ...
    def __init__(self, base="esoutdist", ######################################### 
                 domains=None, activities=None,
                 max_source=100, transform='none',
                 outdist=None, outdist_size=None, outdist_class=None):
        st = time.time()
        self.domains = domains
        print("ODD.py >>> domains:", domains)
        self.activity = activities
        print("ODD.py >>> activities:", activities)
        self.max_source = max_source
        print("ODD.py >>> max_source:", max_source)
        self.outdist = outdist
        print("ODD.py >>> outdist:", outdist)
        self.outdist_size = outdist_size
        print("ODD.py >>> outdist_size:", outdist_size)
        self.outdist_class = outdist_class
        print("ODD.py >>> outdist_class:", outdist_class)
        ...
        assert (base in ["cifar10outdist", "imagenetoutdist", "cifar100outdist", "esoutdist"])
        ...
        if base == 'cifar10outdist':
            ...
            if transform == 'src':
                ...
                # if self.Resize in ["oneclassrepeat", "divide", "repeat"]:
