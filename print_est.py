...
CORRUPTION_LIST = ["l1_param_1","l1_param_2","l1_param_3","l1_param_4","l1_param_5","l5_param_1","l5_param_2","l5_param_3","l5_param_4","l5_param_5"]
...
def main(args):
    ...
    with Pool(processes=len(paths)) as p:
        ...
        ## Check(--esoutdist, src_validation)
        # paths : ['log/esoutdist/TENT_outdist']
        # processes=len(paths): 1
        # len(paths): <function process_path at 0x7f76e942ef70>
        # func:  functools.partial(<function process_path at 0x7fa7320b7f70>, Namespace(dataset='esoutdist', method=['TENT'], seed=[0, 1, 2], outdist=['original'], prefix='eval_results', dist=1, reset='', cont=False, suffix='', target='src_validation', log_name='log/'))
        # args: args:  Namespace(dataset='esoutdist', method=['TENT'], seed=[0, 1, 2], outdist=['original'], prefix='eval_results', dist=1, reset='', cont=False, suffix='', target='src_validation', log_name='log/')
