...
BASE_DATASETS=("imagenetoutdist") # cifar10outdist cifar100outdist imagenetoutdist
...
GPUS=(0 1 2 3) #0 1 2 3 4 5 6 7) #available gpus
NUM_GPUS=${#GPUS[@]}
...
wait_n() {
  ...
  background=($(jobs -p))
  local default_num_jobs=8  #num concurrent jobs  ################### maxjob edit!!
  local num_max_jobs=${8:-$default_num_jobs}  ################### maxjob edit!!
