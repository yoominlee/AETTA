...
class EATA(ETA):
    def __init__(self, model_, corruption_list_):
        ...
        if conf.args.dataset in ["cifar10outdist", "cifar100outdist", "imagenetoutdist", "esoutdist"]:
        ...
        elif conf.args.dataset == "es":
            fisher_dataset = ESDataset(file="", domain=corruption_list_[0], max_source=9999, transform='val')
        else:
