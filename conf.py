...
# tiny = { # XXXXXXXXXXXXXXXXX
#     # git/ImageNet-ES/configs/tin_config.py 참고
#     'name': 'tiny',
...
#     'file_path': './datasets/ImageNet-ES/es-test/auto_exposure/l1',
    
#     'domains': ["param_1", "param_2", "param_3", "param_4", "param_5"],

#     ##############   <<----------    이부분 수정!!
#     'src_domains': ["original"],
#     'tgt_domains': ["l1-param_1", "l1-param_2", "l1-param_3", "l1-param_4", "l1-param_5",
#                     "l5-param_1", "l5-param_2", "l5-param_3", "l5-param_4", "l5-param_5"]
...
IMAGENET_ES = {
    ...
    'file_path': './dataset/ImageNet-ES',
    
    'domains': ["l1_param_1", "l1_param_2", "l1_param_3", "l1_param_4", "l1_param_5",
                "l5_param_1", "l5_param_2", "l5_param_3", "l5_param_4", "l5_param_5"],
           
    ##############   <<----------    이부분 수정!!
    'src_domains': ["original"],
    'tgt_domains': ["l1_param_1", "l1_param_2", "l1_param_3", "l1_param_4", "l1_param_5",
                    "l5_param_1", "l5_param_2", "l5_param_3", "l5_param_4", "l5_param_5"],
    'indices_in_1k' : None
